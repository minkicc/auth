...
When CIAM/IAM organization data exists and the downstream OIDC client requests `profile`, Auth can also include `org_id`, `org_slug`, `org_roles`, and `org_groups` in the ID Token and `/oauth2/userinfo`.
