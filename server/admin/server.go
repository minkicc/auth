...
func (s *AdminServer) registerRoutes(r *gin.Engine, webFilePath string) {
	...
	admin.Use(s.authMiddleware())
	{
		...
		globalAdmin := admin.Group("")
		globalAdmin.Use(s.globalAdminMiddleware())
		...
		// User list
		globalAdmin.GET("/users", s.handleGetUsers)

		// User activity
		globalAdmin.GET("/activity", s.handleGetActivity)

		// User session information
		globalAdmin.GET("/user/:id/sessions", s.handleGetUserSessions)
		globalAdmin.DELETE("/user/:id/sessions/:session_id", s.handleTerminateUserSession)
		globalAdmin.DELETE("/user/:id/sessions", s.handleTerminateAllUserSessions)

		// CIAM organization management
		admin.GET("/organizations", s.handleListOrganizations)
		globalAdmin.POST("/organizations", s.handleCreateOrganization)
		admin.GET("/organizations/:id", s.handleGetOrganization)
		admin.PATCH("/organizations/:id", s.handleUpdateOrganization)
		admin.GET("/organizations/:id/admins", s.handleListOrganizationAdmins)
		globalAdmin.POST("/organizations/:id/admins", s.handleCreateOrganizationAdmin)
		globalAdmin.DELETE("/organizations/:id/admins/:user_id", s.handleDeleteOrganizationAdmin)
		...
		globalAdmin.GET("/claim-mappers", s.handleListClaimMappers)
		globalAdmin.POST("/claim-mappers", s.handleCreateClaimMapper)
		globalAdmin.PATCH("/claim-mappers/:id", s.handleUpdateClaimMapper)
		globalAdmin.DELETE("/claim-mappers/:id", s.handleDeleteClaimMapper)
		globalAdmin.GET("/oidc/clients", s.handleListOIDCClients)
		globalAdmin.POST("/oidc/clients", s.handleCreateOIDCClient)
		globalAdmin.PATCH("/oidc/clients/:client_id", s.handleUpdateOIDCClient)
		globalAdmin.DELETE("/oidc/clients/:client_id", s.handleDeleteOIDCClient)
		globalAdmin.GET("/security/secrets/status", s.handleGetSecretsStatus)
		globalAdmin.GET("/security/audit", s.handleGetSecurityAudit)
		globalAdmin.GET("/security/audit/export", s.handleExportSecurityAudit)
		globalAdmin.GET("/security/audit/export-jobs", s.handleListSecurityAuditExportJobs)
		globalAdmin.POST("/security/audit/export-jobs", s.handleCreateSecurityAuditExportJob)
		globalAdmin.POST("/security/audit/export-jobs/cleanup", s.handleCleanupSecurityAuditExportJobs)
		globalAdmin.GET("/security/audit/export-jobs/:job_id", s.handleGetSecurityAuditExportJob)
		globalAdmin.DELETE("/security/audit/export-jobs/:job_id", s.handleDeleteSecurityAuditExportJob)
		globalAdmin.GET("/security/audit/export-jobs/:job_id/download", s.handleDownloadSecurityAuditExportJob)
		globalAdmin.GET("/security/secrets/audit", s.handleGetSecretsAudit)
		globalAdmin.GET("/security/secrets/audit/export", s.handleExportSecretsAudit)
		globalAdmin.GET("/security/secrets/audit/export-jobs", s.handleListSecretsAuditExportJobs)
		globalAdmin.POST("/security/secrets/audit/export-jobs", s.handleCreateSecretsAuditExportJob)
		globalAdmin.POST("/security/secrets/audit/export-jobs/cleanup", s.handleCleanupSecretsAuditExportJobs)
		globalAdmin.GET("/security/secrets/audit/export-jobs/:job_id", s.handleGetSecretsAuditExportJob)
		globalAdmin.DELETE("/security/secrets/audit/export-jobs/:job_id", s.handleDeleteSecretsAuditExportJob)
		globalAdmin.GET("/security/secrets/audit/export-jobs/:job_id/download", s.handleDownloadSecretsAuditExportJob)
		globalAdmin.POST("/security/secrets/reseal", s.handleResealManagedSecrets)

		// Plugin management
		globalAdmin.GET("/plugins", s.handleGetPlugins)
		globalAdmin.GET("/plugins/audit", s.handleGetPluginAudit)
		globalAdmin.GET("/plugins/backups", s.handleGetPluginBackups)
		globalAdmin.GET("/plugins/catalog", s.handleGetPluginCatalog)
		globalAdmin.GET("/plugins/:id/config", s.handleGetPluginConfig)
		globalAdmin.POST("/plugins/preview", s.handlePreviewPlugin)
		globalAdmin.POST("/plugins/install", s.handleInstallPlugin)
		globalAdmin.POST("/plugins/install-catalog", s.handleInstallPluginFromCatalog)
		globalAdmin.POST("/plugins/install-url", s.handleInstallPluginFromURL)
		globalAdmin.POST("/plugins/restore", s.handleRestorePluginBackup)
		globalAdmin.PATCH("/plugins/:id/config", s.handleUpdatePluginConfig)
		globalAdmin.PATCH("/plugins/:id", s.handleUpdatePlugin)
		globalAdmin.DELETE("/plugins/:id", s.handleDeletePlugin)
