...
const (
	defaultEmailLoginCodeTitle   = "Auth 登录验证码 / Login Verification Code"
	defaultEmailLoginCodeContent = "<h2>Auth 登录验证码</h2><p>您的登录验证码是：</p><p style=\"font-size:24px;font-weight:700;letter-spacing:4px\">{{.Code}}</p><p>验证码将在5分钟后过期。如果不是您本人操作，请忽略此邮件。</p><hr><h2>Auth Login Verification Code</h2><p>Your login verification code is:</p><p style=\"font-size:24px;font-weight:700;letter-spacing:4px\">{{.Code}}</p><p>This code expires in 5 minutes. If you did not request it, please ignore this email.</p>"
)
