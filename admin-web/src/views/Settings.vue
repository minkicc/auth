...
<template>
  <div class="settings-container">
    <el-card class="settings-card">
      ...
      <el-alert
        class="plugin-alert"
        title="本地插件 ZIP 包内需要包含 auth-plugin.yaml，并声明 permissions；flow_action 插件若使用 HTTP Action，需要声明 hook:* 与 network:http_action。签名、host allowlist 和权限 allowlist 会在服务端安装前统一校验。"
        type="info"
        :closable="false"
        show-icon
      />
