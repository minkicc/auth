...
export const adminBrand: AdminBrand = {
  name: envText('VITE_ADMIN_BRAND_NAME', 'minki-auth'),
  section: envText('VITE_ADMIN_BRAND_SECTION', 'admin'),
  pageTitle: envText('VITE_ADMIN_PAGE_TITLE', 'minki-auth admin'),
  homeTitle: envText('VITE_ADMIN_HOME_TITLE', 'minki-auth admin'),
  iconUrl: envText('VITE_ADMIN_ICON_URL', '/minki-logo.svg'),
}
