...
> Auth is already an extensible B2B CIAM platform. The next phase is about making authorization and extensibility first-class enough to grow into a deeper IAM foundation.
