...
export const authBrand: AuthBrand = {
  name: envText('VITE_AUTH_BRAND_NAME', 'auth'),
  kicker: envText('VITE_AUTH_BRAND_KICKER', 'Open Source Contributors'),
  pageTitle: envText('VITE_AUTH_PAGE_TITLE', 'auth'),
  homeTitle: envText('VITE_AUTH_HOME_TITLE', 'auth'),
  iconUrl: envText('VITE_AUTH_ICON_URL', '/auth-logo.svg'),
}
