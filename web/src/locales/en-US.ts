...
export default {
  ...
  organizationSelect: {
    ...
    subtitle: 'This account belongs to multiple organizations. After you choose one, Auth pins the OIDC authorization, tokens, and userinfo response to that organization context.',
    clientId: 'Client',
