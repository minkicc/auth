...
export default {
  ...
  auth: {
    ...
    enterpriseEmailLoginHint: 'Enter your work email and Auth will discover the matching enterprise login from verified domains.',
  ...
  profile: {
    ...
    organizationAuthorizationHint: 'Choose the platform or an enterprise identity. Auth uses the selected context as the default for future authorization.',
  ...
  organizationSelect: {
    ...
    subtitle: 'This account belongs to multiple organizations, and can also continue with the platform/personal identity. Auth pins this OIDC authorization, tokens, and userinfo response to the selected context.',
    clientId: 'Client',
