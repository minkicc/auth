...
export default {
  ...
  profile: {
    ...
    organizationAuthorization: 'Current Identity Context',
    organizationAuthorizationHint: 'Choose the platform or an enterprise identity. MKAuth uses the selected context as the default for future authorization.',
    platformIdentity: 'Platform',
    platformAuthorizationHint: 'The current context is the platform identity, without entering any enterprise organization.',
    activeScopeUpdateFailed: 'Failed to switch the current identity',
  ...
  organizationSelect: {
    ...
    title: 'Choose the identity for this sign-in',
    subtitle: 'This account belongs to multiple organizations, and can also continue with the platform/personal identity. MKAuth pins this OIDC authorization, tokens, and userinfo response to the selected context.',
    clientId: 'Client',
    organizationCount: 'Organizations',
    identityCount: 'Identities',
    identityType: 'Identity Type',
    platformInitial: 'P',
    platformTitle: 'Platform / Personal Identity',
    platformSubtitle: 'Continue without entering any enterprise organization.',
    platformType: 'Platform Identity',
    available: 'Available',
    status: 'Status',
    ...
    continuePlatform: 'Continue with platform identity',
    redirecting: 'Continuing authorization...',
    emptyTitle: 'No available organization was found',
    emptySubtitle: 'If this account should see an organization or platform identity, ask an administrator to review the OIDC client policy, memberships, or directory provisioning.',
