...
func main() {
	...
	log.Printf("Auth resource server example listening on %s", cfg.ListenAddr)
...
func (s *resourceServer) index(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"message": "Auth OIDC resource server example",
...
func loadConfig() appConfig {
	return appConfig{
		...
		ExpectedAudience: envOrDefault("AUTH_EXPECTED_AUDIENCE", defaultExpectedAudience),
		RequiredScope:    strings.TrimSpace(os.Getenv("AUTH_REQUIRED_SCOPE")),
