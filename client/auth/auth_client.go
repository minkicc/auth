...
func (c *AuthClient) UseInsecureTLS() {
	if c.HTTPClient == nil {
...
func (c *AuthClient) LoginVerify(code string) (*LoginVerifyResponse, error) {
	_ = code
...
func (c *AuthClient) WeixinMiniLogin(code string) (*LoginVerifyResponse, error) {
	_ = code
